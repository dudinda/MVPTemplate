...
## How to Test
   ...
   4. Inside a form wrapper <a href="https://github.com/dudinda/Image-Processing/blob/master/Tests/ImageProcessing.App.Integration/Monolith/UILayer/Forms/ColorMatrixFormWrapper.cs#L38">create a bridge</a> with a NonUIForm. 
   5. Inside a presenter use the original source code, <a href="https://github.com/dudinda/Image-Processing/blob/master/Tests/ImageProcessing.App.Integration/Monolith/PresentationLayer/Presenters/MainPresenterWrapper.cs#L73">operating with partial substitutes</a>. Expose substitutes as a public property.
