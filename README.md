...
<p align="center">
    ...
    <p align="center">Fig. 1 - The main form and child SDI transient forms and the singleton form. The main menu also shows the message from the singleton form.</p>
</p>
</br>  
</br>    
<p align="center">
...
<p align="center">
    ...
    <p align="center">Fig. 3 - The console window is started with the main command and then the singleton command is switched to a foreground thread.</p>
</p>
</br>  
</br>    
