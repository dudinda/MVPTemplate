...
6. Implement the <code>IMainView</code> interface for your main form. In case of WinForms you can use the <code>Aggregator.Unpublish</code> inside the <code>Dispose</code> call. Replace the generated dispose with the new syntax or remove it in the case of a singleton, delegating the disposing call to a DI-container.
