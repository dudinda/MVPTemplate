...
## How to Test
   1. Generate or create virtual wrappers around the original components. If a component has a composition with another wrapper, <a href="https://github.com/dudinda/Image-Processing/blob/master/Tests/ImageProcessing.App.Integration/Monolith/ServiceLayer/Providers/BitmapLuminance/Implementation/BitmapLuminanceProviderWrapper.cs#L18">expose its interface as a public property</a>. 
   2. <a href="https://github.com/dudinda/Image-Processing/blob/master/Tests/ImageProcessing.App.Integration/Monolith/UILayer/Forms/ColorMatrixFormWrapper.cs#L19">Extend the original forms with NonUIForms</a>, overriding the write/read methods.
   3. Inside a form wrapper <a href="https://github.com/dudinda/Image-Processing/blob/master/Tests/ImageProcessing.App.Integration/Monolith/UILayer/Forms/ColorMatrixFormWrapper.cs#L38">create a bridge</a> with a NonUIForm. 
   ...
   8. <a href="https://github.com/dudinda/Image-Processing/blob/master/Tests/ImageProcessing.App.Integration/Tests/MainPresenter/MainPresenterTest.cs#L44">You can now write a synchronous scenario using partial substitutes</a>. Raise an event from a form wrapper, when use <code>.Receieved()</code> interface to validate arguments and returns.
